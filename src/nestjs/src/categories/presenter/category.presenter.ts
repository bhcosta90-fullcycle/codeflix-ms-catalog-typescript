import { CategoryOutput } from '@ca/core/category/application/use-cases/dto/category.output';
import { Transform } from 'class-transformer';
import { CollectionPresenter } from '@ca/shared/presenters/collection.presenter';
